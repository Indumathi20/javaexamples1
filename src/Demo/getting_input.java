...
public class getting_input {
	public static void main(String[] args) {
		...
		System.out.println("enter the number to be got");
		int n=sc.nextInt();
		System.out.println(n);
		
		System.out.println("enter the float number to be got");
		float n1=sc.nextFloat();
		System.out.println(n1);
		
		//for word sc.next()
		//for line sc.nextLine()
		//for getting double sc.nextDouble()
		/* C:\javap>javap java.util.Scanner
